/*7.  En un curso se han realizado dos exámenes diferentes, A y B, entre sus 50 alumnos  (alumnos 
pares, examen A; alumnos impares, examen B). Implementa una función que calcule la nota 
media, máxima y mínima de cada examen.*/
